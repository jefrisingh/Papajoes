...
import www.thetunagroup.com.papajoes.AppUrls;
import www.thetunagroup.com.papajoes.Home;
...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences= this.getSharedPreferences("Papajoe", Context.MODE_PRIVATE);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                String response=Interaction.postGetData(AppUrls.loginUrl,entity);
                if (response.contains("success"))
                {
                    ...
                    sharedPreferences.edit().putString("store_id",store_id).apply();
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                homeIntent.putExtra("store_id",store_id);
